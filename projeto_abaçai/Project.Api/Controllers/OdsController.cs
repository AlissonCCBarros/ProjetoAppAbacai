...
namespace Project.Core.Api.Controllers
{
    ...
    public class OdsController : OdsControllerBase
    {
        public OdsController(OdsService service, OdsRepository rep, ILoggerFactory logger, EnviromentInfo env)
            : base(service, rep, logger, env)
        { }


        [Authorize]
        [HttpGet("GetOdsUserLogged")]
        public async Task<IActionResult> GetOdsUserLogged([FromQuery]OdsFilter filters)
        {
